package com.classichu.locationclient;
...
public class ClassicLocationClientHelper {
    private static LocationClient mLocationClient = null;
    public static ClassicBDLocationListenerImpl mClassicBDLocationListenerImpl;

    public static void initLocationClient(Context context) {
        WeakReference<Context> contextWeakReference=new WeakReference<>(context);
        mLocationClient = new LocationClient(contextWeakReference.get());     //声明LocationClient类 getApplicationContext()
        mClassicBDLocationListenerImpl = new ClassicBDLocationListenerImpl();
        mLocationClient.registerLocationListener(mClassicBDLocationListenerImpl);    //注册监听函数
    ...
    public static void startLocation(OnLocationCallBack onLocationCallBack) {
        ...
        if (onLocationCallBack != null) {
            mClassicBDLocationListenerImpl.setOnLocationCallBack(onLocationCallBack);
            mLocationClient.registerLocationListener(mClassicBDLocationListenerImpl);    //注册监听函数
        }
    ...
    public static void stopLocation() {
        ...
        mClassicBDLocationListenerImpl=null;
    }
     ...
     */
    public static class ClassicBDLocationListenerImpl implements BDLocationListener {
